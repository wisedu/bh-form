...
/***/ function(module, exports, __webpack_require__) {
	...
	var bhForm = __webpack_require__(160);
	...
	$.getJSON("./model.json", function (pageMate) {
	  ...
	  ReactDOM.render(React.createElement(Form, { models: model, cols: "3" }), document.getElementById("app"));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Field = __webpack_require__(162);
	
	module.exports = { Form: Form, Input: Input, Field: Field, Label: Label };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Field = __webpack_require__(162);
	...
	var Form = _react2.default.createClass({
	  ...
	  render: function render() {
	    var items = this.props.models.map(function (item, index) {
	      return _react2.default.createElement(_Field2.default, { key: item.name, model: item });
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Field = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      "div",
	      { className: "bh-form-group" },
	      _react2.default.createElement(_Label2.default, { caption: this.props.model.caption }),
	      _react2.default.createElement(
	        "div",
	        { className: "bh-control-entry " },
	        _react2.default.createElement(_Input2.default, { model: this.props.model })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Input = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {},
	  render: function render() {
	    return _react2.default.createElement("input", { type: "text", className: "bh-form-control" });
	  }
	});
